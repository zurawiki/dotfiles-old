...
################################################
echo "always boot in verbose mode (not MacOS GUI mode)"
...
echo "Menu bar: hide the Time Machine and User icons"
...
defaults write com.apple.finder FXPreferredViewStyle -string "clmn";ok
